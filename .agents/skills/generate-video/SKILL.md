...
Reference the prompt at `.Codex/skills/generate-video/prompts/manim_codegen.md`

### HTML Code Guidelines
Reference the prompt at `.Codex/skills/generate-video/prompts/html_codegen.md`
